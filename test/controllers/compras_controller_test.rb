...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { cliente: @compra.cliente, fecha_compra: @compra.fecha_compra, monto: @compra.monto } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { cliente: @compra.cliente, fecha_compra: @compra.fecha_compra, monto: @compra.monto } }
